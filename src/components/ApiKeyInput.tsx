...
export default function ApiKeyInput({ onKeySet }: ApiKeyInputProps) {
  ...
  return (
    <div className="bg-surface border border-border rounded-xl p-6 mb-6">
      <h2 className="text-lg font-semibold mb-2">Google AI API-nøkkel</h2>
      <p className="text-sm text-secondary mb-4">
        Bruker Google Imagen 3 for bilderedigering. Estimert kostnad: ~$0.04 per
        bilde. Nye Google Cloud-kontoer får $300 i gratis credits.{" "}
        <a
        ...
        >
          Opprett API-nøkkel i Google AI Studio →
        </a>
      </p>
